      ...
      <div class="container-fluid bodybox">
        <div class="row mx-0 whole_content align-items-center">
          ...
          <div class="login_container card shadow border py-5 mt-4 rounded">
            <h4 class="text-center text-primary font-weight-bold"><u>Login Here</u></h4>
                <?php 
                      if(@$_GET['Invalid']){
                ...
                <form action="progress.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" name="password" id="" placeholder="eg. ****">
                    </div>
                    <center>
                   <a name="" id="" class="btn btn-info" href="./register.php" role="button">Register</a>
                   <button type="submit" name="sign_in" class="btn btn-primary">Login</button></center>
                </form>
            </div>
          </div>
        </div>
